...
$SQL = "SELECT * FROM vieCAPDerivativesAndCodes, tblNVDPrices WHERE ModelCode = ".intval($_GET['modelcode'])." AND CAPIDNumber = CAPID AND DateOptionEffectiveTo IS NULL ORDER BY DerivDescription ASC";
...
if (mssql_num_rows($result)) {
	while ($row = mssql_fetch_assoc($result)) {
		$return[] = array(
									'CAPID' => $row['CAPID'], 
									'DerivDescription' => $row['DerivDescription'],
