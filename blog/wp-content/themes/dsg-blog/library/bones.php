	...
	*/
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			...
			'car_brands' => 'Car Brand Links' // secondary nav in footer
		)
	);	
}
...
function dsgac_car_brands() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => 'car_brands', /* menu name */
    		'theme_location' => 'car_brands', /* where in the theme it's assigned */
    		'container_class' => 'car-brand-links' /* container class */
    	)
	);
}
