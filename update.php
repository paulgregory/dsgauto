...
*/
?>
<title>DSGAC Car Image Editing - Update</title>
<style type="text/css">
body {
	font-family: arial;
...
<tr>
<td>&nbsp;</td>
<td colspan="3"><strong>Updating Cars</strong> </td>
</tr>
<tr>
<td align="center">&nbsp;</td>
<td align="center">&nbsp;</td>
...
<tr>
<td>&nbsp;</td>
<td align="center"><input name="small" type="text" value="<?php echo $rows['small'];?>" size="30"></td>
<td align="center"><input name="large" type="text" value="<?php echo $rows['large'];?>" size="30"></td>
<td align="center"><input name="name" type="text" value="<?php echo $rows['name']; ?>" size="30"></td>
</tr>
<tr>
<td>&nbsp;</td>
